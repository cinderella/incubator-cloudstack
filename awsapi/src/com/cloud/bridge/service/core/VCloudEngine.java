...
// under the License.
package com.cloud.bridge.service.core;
 ...
 *
 */
public class VCloudEngine {
   protected final static Logger logger = Logger.getLogger(VCloudEngine.class);
   ...
   public VCloudEngine() throws IOException {
      loadConfigValues();
   }
   ...
   private VCloudClient getApi() {
      if (vcloudApi == null) {
         ...
         overrides.setProperty("jclouds.ssh.max-retries", "5");
...
*/
    ...
    * @throws java.sql.SQLException, ClassNotFoundException, IllegalAccessException, InstantiationException
    */
/*
